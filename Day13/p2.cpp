...
using dtype = __int128;

std::pair<dtype, dtype> get_inputs(std::string& input, std::regex& reg) {
...
dtype get_cost(int a1, int a2, int a3, int a4, int b1, int b2) {
    // [a1 a3] [x]   [b1]
    // [a2 a4] [y] = [b2]
    //     1     [a4 -a3] [b1]   [x]
    // (ad - bc) [-a2 a1] [b2] = [y]
    ...
    dtype calc1 = a4 * b1 - a3 * b2 + (a4 - a3) * 10000000000000;
    dtype calc2 = -a2 * b1 + a1 * b2 + (a1 - a2) * 10000000000000;
